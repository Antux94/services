...
public class IPostRiskAdmissionsCalculateIncomesMapperTest {
    ...
    public void testMapInDataWithNulls() {
        Assert.assertNull(mapper.mapInData(null));
    }
    ...
    public void testMapOutDataWithNulls() {
        Assert.assertNull(mapper.mapOutData(null));
    }
...
class DummyMock {
    ...
    public Body getBody() {
        ...
        List<InformationSources> informationSourcesList = new ArrayList<InformationSources>();
    ...
    public BBody getBBody() {
        // Similar to getBody(), but creates BBody and its components
        BBody bBody = new BBody();
        // ... (set all fields similarly to getBody())
        return  bBody; // Add this line to return the created BBody object
    }
}
