...
public class IPostRiskAdmissionsCalculateIncomesMapperTest {
    ...
    class DummyMock {
        ...
        public void generateData() {
            ...
            informationSources.setId("Source2");
            informationSources.setIsConsulted(Boolean.FALSE);
            informationSourcesList.add(informationSources);
            ...
            bLaboralInformation.setDeclaratedIncome(Long.valueOf("50000"));
            ...
            bInformationSources.setId("Source2");
            bInformationSources.setIsConsulted(Boolean.FALSE);
            bInformationSourcesList.add(bInformationSources);
