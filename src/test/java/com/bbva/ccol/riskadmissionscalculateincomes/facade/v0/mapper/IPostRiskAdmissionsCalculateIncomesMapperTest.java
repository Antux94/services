...
public class IPostRiskAdmissionsCalculateIncomesMapperTest {
    ...
    public void testMapInDataWithNulls() {
        ...
        Assert.assertNotNull(bBody); // bBody shouldn't be null even with null inner objects
    }
    ...
    public void testMapOutDataWithNulls() {
        ...
        Assert.assertNotNull(body); // body shouldn't be null even with null inner objects
    }
