...
public class IPostRiskAdmissionsCalculateIncomesMapperTest {
    ...
    public void testMapOutData() {
        ...
        Assert.assertEquals(Boolean.valueOf(bBody.getInformationSources().get(0).getIsConsulted()), body.getInformationSources().get(0).getIsConsulted());
    ...
    private class DummyMock {
        ...
        public BBody getBBody() {
            ...
            bLaboralInformation.setDeclaratedIncome(Long.valueOf(5000000));
