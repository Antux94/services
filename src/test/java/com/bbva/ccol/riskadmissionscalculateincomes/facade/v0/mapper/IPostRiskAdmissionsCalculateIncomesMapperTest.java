...
public class IPostRiskAdmissionsCalculateIncomesMapperTest {
    ...
    public void testMapOutData() {
        ...
        for (int i = 0; i < bBody.getInformationSources().size(); i++) {
            ...
            Assert.assertEquals(Boolean.valueOf(bBody.getInformationSources().get(i).getIsConsulted()), body.getInformationSources().get(i).getIsConsulted());
        }
    ...
    public class DummyMock {
        ...
        public void init() {
            ...
            //BBody Data (mirrored from Body for simplicity)
