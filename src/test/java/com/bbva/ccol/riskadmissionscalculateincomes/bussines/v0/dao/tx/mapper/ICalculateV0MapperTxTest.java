...
public class ICalculateV0MapperTxTest {
    ...
    public void testMapInApxData() {
        ...
        Assert.assertEquals(request.getPerson().getLaboralInformation().getDeclaratedIncome().doubleValue(), bLaboralInformation.getDeclaratedIncome(), 0);
    ...
    public class DummyMock {
        ...
        public RequestTransactionCmlct001_1 getRequestTransactionCmlct001_1() {
            ...
            laboralInformation.setDeclaratedIncome(Long.valueOf(50000)); // Conversion to Long
