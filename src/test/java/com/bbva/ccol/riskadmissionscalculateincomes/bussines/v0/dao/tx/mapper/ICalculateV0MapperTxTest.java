...
public class ICalculateV0MapperTxTest {
    ...
    public void mapInApxDataTest() {
        ...
        Assert.assertEquals(source.getPerson().getLaboralInformation().getDeclaratedIncome(), Double.valueOf(destination.getPerson().getLaboralInformation().getDeclaratedIncome()));


        // Assertions for BInformationSources List
    ...
    class DummyMock {
        ...
        public RequestTransactionCmlct001_1 getRequestTransactionCmlct001_1() {
            ...
            laboralInformation.setDeclaratedIncome(5000000.0); // Use Double for declaredIncome
