...
public class ICalculateV0MapperTxTest {
    ...
    public void testMapInApxData() {
        ...
        Assert.assertEquals(request.getPerson().getLaboralInformation().getDeclaratedIncome(), Double.valueOf(bLaboralInformation.getDeclaratedIncome()));
    ...
    class DummyMock {
        ...
        public RequestTransactionCmlct001_1 getRequestTransactionCmlct001_1() {
            ...
            laboralInformation.setDeclaratedIncome(5000000.0); // Using Double
