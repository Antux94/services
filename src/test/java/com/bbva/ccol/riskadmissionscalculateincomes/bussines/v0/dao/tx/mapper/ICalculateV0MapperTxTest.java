...
public class ICalculateV0MapperTxTest {
    ...
    public void mapInApxDataTest() {
        ...
        Assert.assertEquals(requestTransactionCmlct001_1.getPerson().getLaboralInformation().getDeclaratedIncome().doubleValue(), bBody.getPerson().getLaboralInformation().getDeclaratedIncome(), 0);


        //Information Sources Assertions
        Assert.assertEquals(requestTransactionCmlct001_1.getInformationSources().size(), bBody.getInformationSources().size());
    ...
    class DummyMock {
        ...
        public void init() {
            ...
            laboralInformation.setDeclaratedIncome(Long.valueOf(1000)); // Using Long.valueOf
