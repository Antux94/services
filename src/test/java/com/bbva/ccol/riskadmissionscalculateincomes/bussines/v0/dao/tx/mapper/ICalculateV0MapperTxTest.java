...
public class ICalculateV0MapperTxTest {
    ...
    public void mapInApxDataTest() {
        ...
        // Assertions for IdentityDocument
        ...
        Assert.assertEquals(requestTransactionCmlct001_1.getPerson().getLaboralInformation().getDeclaratedIncome().doubleValue(), bLaboralInformation.getDeclaratedIncome(), 0.0);
        ...
        for (int i = 0; i < bInformationSourcesList.size(); i++) {
            ...
            InformationSources informationSources = requestTransactionCmlct001_1.getInformationSources().get(i);
            Assert.assertEquals(informationSources.getId(), bInformationSources.getId());
            Assert.assertEquals(Boolean.parseBoolean(informationSources.getIsConsulted()), bInformationSources.getIsConsulted());
        }
