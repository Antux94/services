...
public class InformationSources {
	...
	/**
	 * <p>Campo <code>isConsulted</code>, &iacute;ndice: <code>2</code>, tipo: <code>ALFANUMERICO</code>
	 */
	@Campo(indice = 2, nombre = "isConsulted", tipo = TipoCampo.ALFANUMERICO, longitudMaxima = 255, signo = true)
